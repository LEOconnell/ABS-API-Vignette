...
#DELANEY - 2 THIS CREATES THE STRING TO PASS TO GET()
#DELANEY: PARAMETERS FOR TESTING: mypath<-GetAPICallbyNC("CS", "NAICS2017=71")
#THE non function vession of this code works, but this produces an error:
#As tested by: 
#  > GET(mypath)
...
get_path<- paste0(endpath,varlist,query)    
return(get_path)
}
...
```{r wrangleFromJSON}
a1<-GetMyData("CS", "NAICS2017=71")
#             a1<-content(a,as="parsed", encoding="UTF-8")
a2<-ConvertData(a)
a3<-CreateTibble(a2)

#a11<-fromJSON(rawToChar(a$content))
#a111<-as_tibble(a11)
```
